...
/* ~~~~~~~~~ STARTING & MODULE ALL ~~~~~~~~~ */
module.exports = sf = async (sf, m, msg, chatUpdate, store) => {
    try {
        /* ~~~~~~~~~ BASE sfDEV ~~~~~~~~~ */
        const {
            type,
        ...
        const botNumber = await sf.decodeJid(sf.user.id)
        ...
        const groupMetadata = m.isGroup ? await sf.groupMetadata(m.chat).catch(e => {}) : ''
...
/*~~~~~~~~~~~~~ ANTILINK ~~~~~~~~~~~~~~~~~*/
        ...
        async function newReply(teks) {
            ...
            return sf.sendMessage(m.chat, po, {
                quoted: m
            });
        };
        /* ~~~~~~~~~~~ ANTILINK ~~~~~~~~~~~~~*/
...
sf.sendMessage(from, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
        ...
        if (autoread) {
            sf.readMessages([m.key])
        }
        if (autobio) {
            sf.updateProfileStatus(`-`).catch(_ => _)
        }
        ...
        if (isCommand) {
            ...
            sf.sendPresenceUpdate(yte, from)
        }
        if (m.sender.startsWith('212') && global.autoblok212 === true) {
            return sf.updateBlockStatus(m.sender, 'block')
        }
        ...
        for (let i of owner) {
            list.push({
                displayName: sf.getName(i + '@s.whatsapp.net'),
                vcard: `BEGIN:VCARD\n
VERSION:3.0\n
N:${sf.getName(i + '@s.whatsapp.net')}\n
FN:${sf.getName(i + '@s.whatsapp.net')}\n
item1.TEL;waid=${i}:${i}\n
item1.X-ABLabel:Ponsel\n
item2.EMAIL;type=INTERNET:creator@sf.my.id\n
item2.X-ABLabel:Email\n
item3.URL:https://profile.sfdev.xyz\n
...
END:VCARD`
        ...
        if (akinator.hasOwnProperty(m.sender.split('@')[0]) && isCmd && ["0", "1", "2", "3", "4", "5"].includes(body)) {
            ...
            sf.sendText(m.chat, ini_txt, m).then(() => {
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakgambar[m.sender.split('@')[0]]
        ...
        if (tebakasahotak.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Asah Otak 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakasahotak[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaksiapakahaku.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Siapakah Aku 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaksiapakahaku[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaksusunkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Susun Kata 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaksusunkata[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        ...
        if (tebakbendera2.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Bendera 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakbendera2[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebakkabupaten.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Kabupaten 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkabupaten[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebakkimia.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Kimia 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkimia[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaktekateki.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Teka Teki 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaktekateki[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaklagu[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkata[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉`, m)
                delete tebakkalimat[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaklirik[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
        if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == "nyerah") {
                ...
                await sf.sendText(m.chat, `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉`, m)
                delete tebaktebakan[m.sender.split('@')[0]]
            } else newReply('*Jawaban Salah!*')
        }
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
            ...
            if (room.x !== room.o) sf.sendText(room.x, str, m, {
                mentions: parseMention(str)
            })
            sf.sendText(room.o, str, m, {
                mentions: parseMention(str)
            })
            if (isTie || isWin) {
        ...
        if (m.isGroup && !m.key.fromMe) {
            ...
            if (afk.checkAfkUser(m.sender, _afk)) {
                ...
                sf.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} telah kembali dari afk`, m)
            }
        }
        switch (isCommand) {
            case 'autosimi':
            ...
            case 'siq': {
                ...
                let delb = await sf.downloadAndSaveMediaMessage(quoted)
            ...
            case 'join':
                try {
                    ...
                    await sf.groupAcceptInvite(result).then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                } catch {
            ...
            case 'setppbot':
                ...
                var medis = await sf.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
                if (args[0] == 'full') {
                    var {
                        img
                    ...
                    var memeg = await sf.updateProfilePicture(botNumber, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    newReply(mess.done)
            ...
            case 'block':
                ...
                await sf.updateBlockStatus(blockw, 'block').then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                break
            case 'unblock':
                if (!isCreator) return newReply(mess.owner)
                let blockww = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '') + '@s.whatsapp.net'
                await sf.updateBlockStatus(blockww, 'unblock').then((res) => newReply(json(res))).catch((err) => newReply(json(err)))
                break
            case 'leave':
                if (!isCreator) return newReply(mess.owner)
                if (!m.isGroup) return newReply(mess.group)
                newReply('Dadah Semuanya 🥺')
                await sf.groupLeave(m.chat)
                break
            case 'backup':
                if (!isCreator) return newReply(mess.owner)
            ...
            case 'bcgroup': {
                ...
                let getGroups = await sf.groupFetchAllParticipating()
            ...
            case 'closetime':
                ...
                setTimeout(() => {
                    ...
                    sf.groupSettingUpdate(m.chat, 'announcement')
                    newReply(close)
                }, timer)
                break
            case 'opentime':
                ...
                setTimeout(() => {
                    ...
                    sf.groupSettingUpdate(m.chat, 'not_announcement')
                    newReply(open)
                }, timer)
                break
            case 'kick':
                ...
                await sf.groupParticipantsUpdate(m.chat, [blockwww], 'remove').then((res) => newReply('✅ Berhasil Kick Member')).catch((err) => newReply('❎ Gagal Kick Member'))
                break
            case 'add':
                if (!m.isGroup) return newReply(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return newReply(mess.admin)
                ...
                await sf.groupParticipantsUpdate(m.chat, [blockwwww], 'add').then((res) => newReply('✅ Berhasil Menambahkan Member')).catch((err) => newReply('❎ Gagal Menambakan Member'))
                break
            case 'promote':
                if (!m.isGroup) return newReply(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return newReply(mess.admin)
                ...
                await sf.groupParticipantsUpdate(m.chat, [blockwwwww], 'promote').then((res) => newReply('✅ Berhasil Promote')).catch((err) => newReply('❎ Gagal Promote'))
                break
            case 'demote':
                if (!m.isGroup) return newReply(mess.group)
                if (!isAdmins && !isGroupOwner && !isCreator) return newReply(mess.admin)
                ...
                await sf.groupParticipantsUpdate(m.chat, [blockwwwwwa], 'demote').then((res) => newReply('✅ Berhasil Demote')).catch((err) => newReply('❎ Gagal Demote'))
                break
            case 'setname':
            case 'setsubject':
                if (!m.isGroup) return newReply(mess.group)
                ...
                if (!isBotAdmins) return newReply(mess.botAdmin)
                if (!text) return 'Text ?'
                await sf.groupUpdateSubject(m.chat, text).then((res) => newReply(mess.success)).catch((err) => newReply(json(err)))
                break
            case 'setdesc':
            case 'setdesk':
                if (!m.isGroup) return newReply(mess.group)
                ...
                if (!isBotAdmins) return newReply(mess.botAdmin)
                if (!text) return 'Text ?'
                await sf.groupUpdateDescription(m.chat, text).then((res) => newReply(mess.success)).catch((err) => newReply(json(err)))
                break
            case 'setppgroup':
            case 'setppgrup':
            case 'setppgc':
                ...
                if (args[0] == 'full') {
                    ...
                    var memeg = await sf.updateProfilePicture(m.chat, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    newReply(mess.done)
            ...
            case 'grup':
                ...
                if (!isBotAdmins) return newReply(mess.botAdmin)
                if (args[0] === 'close') {
                    await sf.groupSettingUpdate(m.chat, 'announcement').then((res) => newReply(`Sukses Menutup Group 🕊️`)).catch((err) => newReply(json(err)))
                } else if (args[0] === 'open') {
                    await sf.groupSettingUpdate(m.chat, 'not_announcement').then((res) => newReply(`Sukses Membuka Group 🕊️`)).catch((err) => newReply(json(err)))
                } else {
            ...
            case 'editinfo':
                ...
                if (!isBotAdmins) return newReply(mess.botAdmin)
                if (args[0] === 'open') {
                    await sf.groupSettingUpdate(m.chat, 'unlocked').then((res) => newReply(`Sukses Membuka Edit Info Group 🕊️`)).catch((err) => newReply(json(err)))
                } else if (args[0] === 'close') {
                    await sf.groupSettingUpdate(m.chat, 'locked').then((res) => newReply(`Sukses Menutup Edit Info Group 🕊️`)).catch((err) => newReply(json(err)))
                } else {
            ...
            case 'resetlink':
                ...
                if (!isAdmins && !isGroupOwner && !isCreator) return newReply(mess.admin)
                if (!isBotAdmins) return newReply(mess.botAdmin)
                await sf.groupRevokeInvite(m.chat)
                    .then(res => {
            ...
            case 'liston':
                ...
                sf.sendText(m.chat, '⏰ List Online:\n\n' + online.map(v => '🌱 @' + v.replace(/@.+/, '')).join`\n`, m, {
                    mentions: online
                })
                break
...
`.trim()
            ...
            case 'speedtest': {
                ...
                try {
                    ...
                    if (stdout.trim()) sf.sendMessage(m.chat, {
                        text: stdout,
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                    ...
                    if (stderr.trim()) sf.sendMessage(m.chat, {
                        text: stderr,
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                ...
                sf.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: 'Script Free',
                            body: `SCRIPT BOT ${namabot} Ada Di Youtube @sfdev`,
            ...
            case 's': {
                ...
                if (/image/.test(mime)) {
                    ...
                    let encmedia = await sf.sendImageAsSticker(m.chat, media, m, {
                        packname: packname,
                        author: author
                    })
                    ...
                    let media = await quoted.download()
                    let encmedia = await sf.sendVideoAsSticker(m.chat, media, m, {
                        packname: packname,
                        author: author
                    })
                    await fs.unlinkSync(encmedia)
            ...
            case 'smeme': {
                ...
                let dwnld = await sf.downloadAndSaveMediaMessage(qmsg)
                let fatGans = await TelegraPh(dwnld)
                let smeme = `https://api.memegen.link/images/custom/${encodeURIComponent(bawah)}/${encodeURIComponent(atas)}.png?background=${fatGans}`
                let pop = await sf.sendImageAsSticker(m.chat, smeme, m, {
                    packname: packname,
                    author: author
                })
                fs.unlinkSync(pop)
            ...
            case 'swm': {
                ...
                newReply(mess.wait)
                if (/image/.test(mime)) {
                    let media = await sf.downloadMediaMessage(qmsg)
                    let encmedia = await sf.sendImageAsSticker(m.chat, media, m, {
                        packname: teks1,
                        author: teks2
                    })
            ...
            case 'toimg': {
                ...
                newReply(mess.wait)
                let media = await sf.downloadAndSaveMediaMessage(qmsg)
            ...
            case 'emojimix2': {
                ...
                for (let res of anu.results) {
                    let encmedia = await sf.sendImageAsSticker(m.chat, res.url, m, {
                        packname: global.packname,
                        author: global.author,
                        categories: res.tags
                    })
            ...
            case 'toviewonce': {
                ...
                if (/image/.test(mime)) {
                    anuan = await sf.downloadAndSaveMediaMessage(quoted)
                    sf.sendMessage(m.chat, {
                        image: {
                            url: anuan
                        },
                    ...
                    anuanuan = await sf.downloadAndSaveMediaMessage(quoted)
                    sf.sendMessage(m.chat, {
                        video: {
                            url: anuanuan
                        },
            ...
            case 'liststicker': {
                ...
                for (let x of Stickersf) {
                    teks += `│⭔ ${x}\n`
                }
                teks += `│\n└────────────⭓\n\n*Total : ${Stickersf.length}*`
                newReply(teks)
            }
            break
            case 'listimage': {
                let teks = '┌──⭓「 *List Image* 」\n│\n'
                for (let x of Imagesf) {
                    teks += `│⭔ ${x}\n`
                }
                teks += `│\n└────────────⭓\n\n*Total : ${Imagesf.length}*`
                newReply(teks)
            }
            break
            case 'listvideo': {
                let teks = '┌──⭓「 *List Video* 」\n│\n'
                for (let x of Videosf) {
                    teks += `│⭔ ${x}\n`
                }
                teks += `│\n└────────────⭓\n\n*Total : ${Videosf.length}*`
                newReply(teks)
            }
            break
            case 'addvideo': {
                ...
                if (Videosf.includes(q)) return newReply("Nama Yang Kamu Masukan Sudah Ada")
                let delb = await sf.downloadAndSaveMediaMessage(quoted)
                Videosf.push(q)
                await fsx.copy(delb, `./media/video/${q}.mp4`)
                fs.writeFileSync('./src/media/video.json', JSON.stringify(Videosf))
                fs.unlinkSync(delb)
            ...
            case 'delvideo': {
                ...
                if (!Videosf.includes(q)) return newReply("Nama Tidak Ada Di Dalam Database")
                let wanu = Videosf.indexOf(q)
                Videosf.splice(wanu, 1)
                fs.writeFileSync('./src/media/video.json', JSON.stringify(Videosf))
            ...
            case 'addimage': {
                ...
                if (Imagesf.includes(q)) return newReply("Nama Yang Kamu Masukan Sudah Terdaftar Di Dalam Database")
                let delb = await sf.downloadAndSaveMediaMessage(quoted)
                Imagesf.push(q)
                await fsx.copy(delb, `./media/image/${q}.jpg`)
                fs.writeFileSync('./src/media/image.json', JSON.stringify(Imagesf))
                fs.unlinkSync(delb)
            ...
            case 'delimage': {
                ...
                if (!Imagesf.includes(q)) return newReply("Nama Image Yang Kamu Masukan Tidak Terdaftar")
                let wanu = Imagesf.indexOf(q)
                Imagesf.splice(wanu, 1)
                fs.writeFileSync('./src/media/image.json', JSON.stringify(Imagesf))
            ...
            case 'addsticker': {
                ...
                if (Stickersf.includes(q)) return newReply("Nama Telah Di Pakai")
                let delb = await sf.downloadAndSaveMediaMessage(quoted)
                Stickersf.push(q)
                await fsx.copy(delb, `./media/sticker/${q}.webp`)
                fs.writeFileSync('./src/media/sticker.json', JSON.stringify(Stickersf))
                fs.unlinkSync(delb)
            ...
            case 'delsticker': {
                if (!isPremium) return newReply(mess.prem)
                if (args.length < 1) return newReply('Masukan Nama Stickernya')
                if (!Stickersf.includes(q)) return newReply("Nama Tidak Terdaftar Di Database")
                let wanu = Stickersf.indexOf(q)
                Stickersf.splice(wanu, 1)
                fs.writeFileSync('./src/media/sticker.json', JSON.stringify(Stickersf))
            ...
            case 'addvn': {
                ...
                if (Vnsf.includes(q)) return newReply("Nama Telah Di Pakai")
                let delb = await sf.downloadAndSaveMediaMessage(quoted)
                Vnsf.push(q)
                await fsx.copy(delb, `./media/audio/${q}.mp3`)
                fs.writeFileSync('./src/media/vn.json', JSON.stringify(Vnsf))
                fs.unlinkSync(delb)
            ...
            case 'delvn': {
                if (!isPremium) return newReply(mess.prem)
                if (args.length < 1) return newReply('Masukan Namanya')
                if (!Vnsf.includes(q)) return newReply("Nama Tidak Terdaftar Di Database")
                let wanu = Vnsf.indexOf(q)
                Vnsf.splice(wanu, 1)
                fs.writeFileSync('./src/media/vn.json', JSON.stringify(Vnsf))
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
                    if (room.x !== room.o) await sf.sendText(room.x, str, m, {
                        mentions: parseMention(str)
                    })
                    await sf.sendText(room.o, str, m, {
                        mentions: parseMention(str)
                    })
                } else {
                    room = {
            ...
            case 'delttt': {
                ...
                try {
                    if (this.game) {
                        delete this.game
                        sf.sendText(m.chat, `Berhasil delete session TicTacToe`, m)
                    } else if (!this.game) {
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
                this.suit[id] = {
                    chat: await sf.sendText(m.chat, caption, m, {
                    ...
                    status: 'wait',
                    waktu: setTimeout(() => {
                        if (this.suit[id]) sf.sendText(m.chat, `_Waktu suit habis_`, m)
                        delete this.suit[id]
                    }, 60000),
                    poin,
                    poin_lose,
            ...
            case 'math': {
                ...
                sf.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
            ...
            case 'tebak': {
                if (args[0] === 'gambar') {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    sf.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    sf.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    sf.sendText(m.chat, `Jawablah Pertanyaan Berikut : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    sf.sendImage(m.chat, result.url, `Silahkan Jawab Gambar Berikut\n\nWaktu : 60s`, m).then(() => {
            ...
            case 'akinatorstart':
                ...
                sf.sendText(m.chat, imi_txt, m).then(() => {
            ...
            case 'openai': {
                ...
                let d = await fetchJson(`https://api.betabotz.org/api/search/openai-chat?text=${full_args}&apikey=${beta}`)                
                await sf.sendMessage(from, {
                    text: d.result
                }, { quoted: m})
            }
            ...
            */
            ...
            case 'ytmp4': {
                ...
                await sf.sendMessage(m.chat, {
                    ...
                    mimetype: 'video/mp4',
                    fileName: "Downloader Ytmp4 By sfdev.mp4",
                    caption: ytmp4p,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
            ...
            case 'ytmp3': {
                ...
                await sf.sendMessage(m.chat, {
                    ...
                    mimetype: 'audio/mp3',
                    fileName: "Downloader Ytmp3 By sfdev.mp3",
                    caption: ytmp4p,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
            ...
            case 'qc': {
                ...
                let ppnyauser = await await sf.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/6880771a42bad09dd6087.jpg')
                const rest = await quote(q, pushname, ppnyauser)
                newReply(mess.wait)
                sf.sendImageAsSticker(m.chat, rest.result, m, {
                    packname: `${global.packname}`,
                    author: `${global.author}`
                })
            }
            ...
            case 'hd': {
                ...
                let media = await sf.downloadAndSaveMediaMessage(quoted)
                let anu = await TelegraPh(media)
                sf.sendMessage(m.chat, {
                    image: {
            ...
            case 'reminiv2': {
                ...
                await sf.sendMessage(m.chat, {
                    image: {
                        url: `https://xzn.wtf/api/torch-srgan?url=${anu}&apikey=${beta}`
                    },
                    caption: mess.done
                }, {
                    quoted: m
            ...
            case 'recolor': {
                ...
                await sf.sendMessage(m.chat, {
                    image: {
                        url: `https://xzn.wtf/api/colorizer?url=${anu}&apikey=${beta}`
                    },
                    caption: mess.done
                }, {
                    quoted: m
            ...
            case 'telestick': {
                ...
                for (var ki = 0; ki < agg.result.sticker.length; ki++) {
                    await sf.sendImageAsSticker(m.chat, agg.result.sticker[ki], m, {
                        packname: packname,
                        author: author
                    })
                }
...
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
    ...
    sf.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => reply(mess.error))
break
//////////// SPOTIFY ////////////////
...
case 'waifu':
case 'ana': {
sf.sendMessage(m.chat, { image: { url: `https://api.betabotz.org/api/anime/${command}?apikey=${beta}`}, caption: `Random image for _${command}_\nBy Admin SF`})
}
break
...
╰━━━━━━━━━━━━━━☉`
        ...
        sf.sendText(numberowner + '@s.whatsapp.net', util.format(err), m)
